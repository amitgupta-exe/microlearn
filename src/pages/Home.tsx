      ...
      <main className="max-w-6xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-bold text-gray-900 mb-6">
            ...
            <span className="text-blue-600"> Smart Courses</span>
          </h2>
        ...
        <section className="mb-16">
          <h3 className="text-3xl font-bold text-center mb-12 text-gray-900">Why Choose EduLearn?</h3>
        ...
        <section className="mb-16">
          <div className="bg-white rounded-2xl shadow-lg p-12">
            <h3 className="text-3xl font-bold text-center mb-8 text-gray-900">About EduLearn</h3>
